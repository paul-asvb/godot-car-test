...
```bash
PHASE_INFO=$(node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
