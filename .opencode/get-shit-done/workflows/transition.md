...
```bash
TRANSITION=$(node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
