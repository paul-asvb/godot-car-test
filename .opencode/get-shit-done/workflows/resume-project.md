...
<required_reading>
@/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" init resume)
