...
- **Global scope**: `/home/leto/git/github/paul-asvb/godot-car-test/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/leto/git/github/paul-asvb/godot-car-test/.opencode/notes/`)
...
2. Glob `/home/leto/git/github/paul-asvb/godot-car-test/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/leto/git/github/paul-asvb/godot-car-test/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/leto/git/github/paul-asvb/godot-car-test/.opencode/notes/` — works in any directory
