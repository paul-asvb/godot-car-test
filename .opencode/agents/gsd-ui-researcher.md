...
Use template from `/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
