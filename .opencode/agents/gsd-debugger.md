...
```bash
INIT=$(node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/leto/git/github/paul-asvb/godot-car-test/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
